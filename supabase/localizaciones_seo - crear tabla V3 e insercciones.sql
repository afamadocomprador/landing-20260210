...
CREATE TABLE localizaciones_seo (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, -- Nueva Clave Primaria Autoincremental
    slug TEXT UNIQUE, -- Ahora puede ser NULL, pero si tiene valor debe ser único para FKs
...
-- ==============================================================================
CREATE INDEX idx_seo_slug ON localizaciones_seo(slug); -- Indexar el slug para búsquedas rápidas
